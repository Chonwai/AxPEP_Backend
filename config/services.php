...
return [
    ...
    */
    ...
    'bert_hemopep60' => [
        'url' => env('BERT_HEMOPEP60_MICROSERVICE_BASE_URL', 'http://host.docker.internal:9001'),
    ],
    ...
    'bestox' => [
        'url' => env('BESTOX_MICROSERVICE_BASE_URL', 'http://host.docker.internal:8006'),
        'timeout' => env('BESTOX_MICROSERVICE_TIMEOUT', 3600),
        'enabled' => env('USE_BESTOX_MICROSERVICE', true),
    ],

    'ssl_gcn' => [
        'url' => env('SSL_GCN_MICROSERVICE_BASE_URL', 'http://host.docker.internal:8007'),
